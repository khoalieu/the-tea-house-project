            ...
            <div class="form-grid">
                ...
                <div class="form-left">
                    <div class="form-section">
                        ...
                        <form action="/src/main/webapp/admin/categories/add" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-text">Để trống sẽ tự tạo từ tên.</div>
                            </div>
                ...
                <div class="form-right">
                    <div class="form-section">
                        ...
                        <div class="table-responsive">
                            <table class="category-table"> <thead>
                            <tr>
                                <th>Tên danh mục</th>
                                <th>Slug</th>
                                <th>Thao tác</th>
                                ...
                                <tbody>
                                <tr>
                                    <td><strong>Trà Thảo Mộc</strong></td>
                                    <td>/tra-thao-moc</td>
                                    <td>
                                ...
                                <tr>
                                    <td><strong>Nguyên Liệu Trà Sữa</strong></td>
                                    <td>/nguyen-lieu-tra-sua</td>
                                    <td>
                                        <div class="action-buttons">
                                            <button class="btn-action edit" title="Sửa"><i class="fas fa-edit"></i></button>
                                            <button class="btn-action delete" title="Xóa"><i class="fas fa-trash"></i></button>
                                ...
                                <tr>
                                    <td class="child-category">--- Topping & Trân Châu</td>
                                    <td>/topping-tran-chau</td>
                                    <td>
                                        <div class="action-buttons">
                                            <button class="btn-action edit" title="Sửa"><i class="fas fa-edit"></i></button>
                                            <button class="btn-action delete" title="Xóa"><i class="fas fa-trash"></i></button>
