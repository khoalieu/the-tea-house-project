  ...
  <div class="login-page forgot-password-page">
    <div class="login-box">
      ...
      <div class="login-content">
        <!-- Sau này bạn đổi action sang servlet, hiện tại ví dụ giữ như bạn -->
        <form action="verify-otp.jsp" method="get" autocomplete="on">
          <div class="form-row">
            <input
                    id="forgot-email"
                    class="input-email"
          ...
          <div class="form-row">
            <button type="submit" class="btn">Gửi liên kết khôi phục</button>
          </div>
